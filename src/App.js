...
function App() {
  ...
  const getData = async () => {
    ...
    for (const endpoint of url_list_endpoints) {
      ...
      info_detail['total_issues'] =
        response_endpoint.developer_data.total_issues;
      info_detail['pull_requests_merged'] =
        response_endpoint.developer_data.pull_requests_merged;
      info_detail['pull_request_contributors'] =
        response_endpoint.developer_data.pull_request_contributors;
      info_detail['closed_issues'] =
        response_endpoint.developer_data.closed_issues;
      ...
      info_detail['public_interest_score'] =
        response_endpoint.public_interest_score;
